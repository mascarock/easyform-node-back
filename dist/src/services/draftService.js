...
export class DraftsService {
    async saveDraft(saveDraftDto, metadata = {}) {
        ...
        const now = new Date();
        try {
            const draftSubmission = await DraftSubmissionModel.findOneAndUpdate({ sessionId }, {
                sessionId,
                formId,
                answers,
                currentStep,
    ...
    async getDraftStatistics(formId) {
    ...
    getLastAnsweredQuestion(answers) {
