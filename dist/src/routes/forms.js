...
router.get('/submissions', asyncHandler(async (req, res) => {
    ...
    const data = await formsService.getFormSubmissions(typeof req.query.formId === 'string' ? req.query.formId : undefined, typeof req.query.userEmail === 'string' ? req.query.userEmail : undefined, limit, offset);
    res.json(data);
}));
...
router.get('/statistics', asyncHandler(async (req, res) => {
    const stats = await formsService.getFormStatistics(typeof req.query.formId === 'string' ? req.query.formId : undefined);
    res.json(stats);
}));
